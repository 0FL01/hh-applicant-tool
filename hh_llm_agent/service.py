        ...
        llm_messages.append(
            {
                ...
                "content": (
                    ...
                    "Правила:\n"
                    "- Для одного короткого screening-вопроса используй reply_mode='short' и отвечай 1-5 словами без объяснений.\n"
                    "- Для нескольких самостоятельных screening-вопросов используй reply_mode='qa_series' и верни 2-3 коротких ответа в порядке вопросов.\n"
                    "- Для сложного открытого вопроса, требующего связного объяснения, используй reply_mode='single'.\n"
